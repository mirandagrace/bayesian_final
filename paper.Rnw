...
\includegraphics{figure/ZIP_Flood_Conv.pdf}

\noindent Figure 1. Cumulative mean plots for the posterior samples of the two parameters from the flood data. Plots for the tornado data are not pictured, but behave similarly.

\includegraphics{figure/ZIP_Density.pdf}

\noindent Figure 2. Posterior density plots for flood parameters (in blue), and tornado parameters (black).
...
ZIP & 10454.860& ZIP FLOOD WAIC &8727.647 &ZIP TORNADO WAIC\\
